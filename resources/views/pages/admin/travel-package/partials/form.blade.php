...
<div class="form-group">
    ...
    <textarea name="about" rows="10" class="d-block w-100 form-control{{ $errors->has('about') ? ' is-invalid' : ''}}">{{ old('about') }}</textarea>
...
<div class="form-group">
    ...
    <input type="text" class="form-control{{ $errors->has('language') ? ' is-invalid' : ''}}" name="language" placeholder="Language" value="{{ old('language') }}">
...
<div class="form-group">
    ...
    <input type="date" class="form-control{{ $errors->has('departure_date') ? ' is-invalid' : ''}}" name="departure_date" placeholder="Departure Date" value="{{ old('departure_date') }}">
...
<div class="form-group">
    ...
    <input type="number" class="form-control{{ $errors->has('price') ? ' is-invalid' : ''}}" name="price" placeholder="Price" value="{{ old('price') }}">
    {!! $errors->first('price', '<span class="invalid-feedback">:message</span>')!!}
</div>
<div class="form-group">
    <label for="image_cover">Image Cover</label>
    <input type="file" class="form-control{{ $errors->has('image_cover') ? ' is-invalid' : ''}}" name="image_cover" placeholder="Image" value="{{ old('image_cover') }}">
