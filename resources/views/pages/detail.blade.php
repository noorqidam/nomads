                ...
                <div class="xzoom-container">
                  ...
                  <div class="xzoom-thumbs">
                    <a href="frontend/images/details-1.jpg">
                      <img class="xzoom-gallery" width="128" src="{{url('frontend/images/details-1.jpg')}}"
                        xpreview="frontend/images/details-1.jpg" />
                    </a>
                    <a href="frontend/images/details-2.jpg">
                      <img class="xzoom-gallery" width="128" src="{{url('frontend/images/details-2.jpg')}}"
                        xpreview="frontend/images/details-2.jpg" />
                    </a>
                    <a href="frontend/images/details-3.jpg">
                    <img class="xzoom-gallery" width="128" src="{{url('frontend/images/details-3.jpg')}}"
                        xpreview="frontend/images/details-3.jpg" />
                    </a>
                    <a href="frontend/images/details-4.jpg">
                      <img class="xzoom-gallery" width="128" src="{{url('frontend/images/details-4.jpg')}}"
                        xpreview="frontend/images/details-4.jpg" />
                    </a>
                    <a href="frontend/images/details-5.jpg">
                      <img class="xzoom-gallery" width="128" src="{{url('frontend/images/details-5.jpg')}}"
          ...
          <div class="col-lg-4">
            <div class="card card-details card-right">
              ...
              <div class="members my-2">
                ...
                <img src="{{url('frontend/images/members-5.png')}}" alt="" class="member-image mr-1" />
              </div>
              <hr />
